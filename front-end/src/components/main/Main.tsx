...
const Main = ({logoName, cards, smallCards, filters, next, prev, typeSmallCard, isEpisode}:Props) => {
  ...
  return (
    ...
    //     ) : (
    //       (isEpisode && (
    //         smallCards?.map((smallCard: IEpisode | ILocation) => (
